...
import '../../settings/changedpassword.dart';
import '../../settings/contact_admin.dart';
import '../../settings/editprofile.dart';
import '../../settings/faq.dart';
import '../../settings/privacypolicy.dart';


class SimplifiedSettingsPageUser extends StatefulWidget {
  const SimplifiedSettingsPageUser({super.key});

  @override
  State<SimplifiedSettingsPageUser> createState() => _SimplifiedSettingsPageState();
}

class _SimplifiedSettingsPageState extends State<SimplifiedSettingsPageUser> {
